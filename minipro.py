...
class Person:
    ...
    def __str__(self):
        final_output = f'{self.first} {self.last} : {self.age} : {self.phone_number}'
        return final_output
...
while(True):
    ...
    if(comand1 == '1'):
        ...
        print("------------------------------------------------------->")
        print("Thank you we have succssfully added your contact info")
        print(our_contact)
        print("------------------------------------------------------->")
        print()
        print()
        ...
        for contact in contacts:
            if(delcon in contact.full_name()):
                ...
                print()
                confer = input(
                    "are you sure you want to delete above contact ?? y/n : ")
                if(confer.lower() == 'y'):
